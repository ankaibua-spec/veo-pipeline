...
def apply_update(zip_path: Path):
    ...
    log_path = Path(tempfile.gettempdir()) / f"veo_swap_log_{nonce}.txt"
    bat_path.write_text(
        "@echo off\r\n"
        ...
        "set /a counter+=1\r\n"
        "if %counter% gtr 60 (\r\n"
        "    echo [%date% %time%] WARN: exit marker timeout >> \"!LOGFILE!\"\r\n"
        "    goto :proceed\r\n"
        ")\r\n"
        ...
        ")\r\n"
        ":proceed\r\n"
        "echo [%date% %time%] proceed after %counter%s wait >> \"!LOGFILE!\"\r\n"
        "\r\n"
        "REM Refuse to mirror if the readiness sentinel is missing.\r\n"
        "if not exist \"!EXTRACT!\\.veo_update_ready\" (\r\n"
        "    echo [%date% %time%] FATAL: sentinel missing - abort >> \"!LOGFILE!\"\r\n"
        "    goto cleanup\r\n"
        ")\r\n"
        "\r\n"
        ...
        "\r\n"
        "echo [%date% %time%] backup phase >> \"!LOGFILE!\"\r\n"
        "robocopy \"!TARGET!\" \"!BACKUP!\" /MIR /R:1 /W:1 /NFL /NDL /NJH /NJS >NUL\r\n"
        "if errorlevel 8 (\r\n"
        "    echo [%date% %time%] FATAL: backup failed - abort install untouched >> \"!LOGFILE!\"\r\n"
        "    goto cleanup\r\n"
        ")\r\n"
        "\r\n"
        "echo [%date% %time%] swap phase >> \"!LOGFILE!\"\r\n"
        "robocopy \"!EXTRACT!\" \"!TARGET!\" /MIR /XF .veo_update_ready /R:2 /W:2 /NFL /NDL /NJH /NJS >NUL\r\n"
        "if errorlevel 8 (\r\n"
        "    echo [%date% %time%] FATAL: swap failed - rollback >> \"!LOGFILE!\"\r\n"
        ...
        ")\r\n"
        "\r\n"
        "REM Wait for filesystem to flush + Defender to scan new exe.\r\n"
        "echo [%date% %time%] waiting 3s before relaunch >> \"!LOGFILE!\"\r\n"
        "timeout /t 3 /nobreak >NUL\r\n"
        "\r\n"
        "echo [%date% %time%] launching: !EXEPATH! >> \"!LOGFILE!\"\r\n"
        "cd /d \"!TARGET!\"\r\n"
        "start \"VEO\" \"!EXEPATH!\"\r\n"
        "if errorlevel 1 (\r\n"
        "    echo [%date% %time%] start failed errorlevel - retry via cmd /c >> \"!LOGFILE!\"\r\n"
        "    timeout /t 2 /nobreak >NUL\r\n"
        "    cmd /c start \"VEO\" \"!EXEPATH!\"\r\n"
        ")\r\n"
        "echo [%date% %time%] start cmd issued >> \"!LOGFILE!\"\r\n"
        "\r\n"
        ":cleanup\r\n"
